...
public class ApplicationDaoImpl implements ApplicationDao {
	...
	public List<String> getOrderableTime(Date selectDate) {
		...
		return session.createQuery(hql).setParameter("d", selectDate)
				.getResultList();
	}
	@Override
	public void changeOrderableTimeStatus(Date selectDate, String selectTime,int status) {
		...
		session.createQuery(hql).setParameter("s", status)
								.setParameter("d", selectDate)
								.setParameter("t",selectTime )
								.executeUpdate();
	}
	...
	public List<ApplicationBean> getAplcBeanByIdByStatus(int memberId, int statusId) {
		...
		return session.createQuery(hql).setParameter("id", memberId)
										.setParameter("s", statusId)
										.getResultList();
	}
	@SuppressWarnings("unchecked")
	@Override
	...
	public void changeAplcBeanPayStatusById(int aplcId,int payStatus) {
		...
		session.createQuery(hql).setParameter("s", payStatus)
								.setParameter("id",aplcId )
								.executeUpdate();
	}
