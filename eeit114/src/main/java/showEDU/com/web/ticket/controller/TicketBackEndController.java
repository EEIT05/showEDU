...
//		String originalFilename = movieImage.getOriginalFilename();
		...
		return "redirect:/ticketBackEnd";
//				"redirect:ticket/ticketBackEnd"; // 在此重新回傳的是邏輯字串，不是jsp名稱
...
//	========================Ajax & Restful=======================
	...
	public MovieBean singlemovie(@RequestParam(value = "movieId", defaultValue = "0") Integer movieId) {
	...
	public ResponseEntity<byte[]> getImage(@RequestParam(value = "id", defaultValue = "0") Integer movieId) {
		byte[] b = null;
