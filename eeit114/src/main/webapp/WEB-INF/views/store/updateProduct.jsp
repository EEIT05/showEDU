...
<%-- 				<%@include file="types/category.jsp"%> --%>
			...
			<section class="item item2">
				...
				<hr>
					...
					<form:form method='POST' modelAttribute="updateProduct"
						enctype="multipart/form-data" class='form-horizontal' style="padding-left:5cm">
						<fieldset>
							...
							<div class="form-group">
								...
								<form:select id="categoryId" path="categoryId" type='text'
									...
									<form:option value="${updateProduct.categoryBean.categoryId }" label="${updateProduct.categoryBean.category }" />
...
<%-- 									<form:option value="-1" label="請挑選" /> --%>
									<form:option value="${updateProduct.productCategoryBean.productCategoryId}" label="${updateProduct.productCategoryBean.items}" />
							...
							<div class="form-group">
								<div class='col-lg-offset-2 col-lg-10'>
									<button id="btnAdd" type='submit' class='btn btn-primary'>儲存</button>
								</div>
							</div>
						</fieldset>
					</form:form>
