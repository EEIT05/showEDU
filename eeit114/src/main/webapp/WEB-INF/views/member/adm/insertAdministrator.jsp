					...
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<form:input path='adname' placeholder="請輸入姓名" class="form-control"
									name="adname" id="adname" />
...
<!-- 					<br></div></div></div> -->
					...
					<div class="form-group">
						...
						<form:input path='adaccount' placeholder="請輸入帳號(example@gmail.com)" class="form-control" name="adaccount" id="adaccount"/>
					...
					<c:if test='${administrator.admId != null}'>
						...
						<form:hidden path='adaccount' /> ${administrator.adaccount}<br>
					</c:if>
					...
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<form:input path="adpswd" placeholder="請輸入密碼" class="form-control"
									name="adpswd" id="adpswd" />
...
<input type='submit' value="一鍵輸入" id="button" class="">
				</form:form>
